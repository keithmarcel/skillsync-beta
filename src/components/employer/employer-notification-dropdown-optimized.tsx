...
/**
 * PRODUCTION-GRADE Employer Notification Dropdown
 * 
 * Uses proper foreign key joins for optimal performance and security.
 * Requires: employer_invitations_user_id_fkey foreign key constraint
 * 
...
export function EmployerNotificationDropdown({ companyId }: EmployerNotificationDropdownProps) {
  ...
  async function loadUnreadCount() {
    ...
    try {
      // OPTIMIZED: Uses indexed query for fast count
